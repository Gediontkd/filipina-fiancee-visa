...
class PaymentHelper
{
    ...
    {
        $application = UserSubmittedApplication::with('visaApplication')
        ...
        $applicationName = $application->visaApplication ? $application->visaApplication->name : 'Unknown';
        $amount = self::getPaymentAmount($applicationName);
