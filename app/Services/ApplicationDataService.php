...
class ApplicationDataService
{
    public function collectApplicationData(UserSubmittedApplication $application): array
    {
        ...
        $applicationType = $application->visaApplication ? $application->visaApplication->name : 'Unknown';
        ...
        return [
            'applicant' => [
                'personal_information' => [
                    ...
                    'has_a_number' => $app->has_a_number ? 'Yes' : 'No',
                    'a_number' => $app->a_number,
                    'has_other_a_numbers' => $app->has_other_a_numbers ? 'Yes' : 'No',
                    'other_a_numbers' => $app->other_a_numbers ?? [],
            ...
            'immigration_status' => [
                'current_visa' => [
                    ...
                    'visa_number' => $app->nonimmigrant_visa_number,
                    'visa_issue_date' => $app->nonimmigrant_visa_issue_date?->format('m/d/Y'),
                ],
                'passport' => [
                    'number' => $app->passport_number,
                    'country' => $app->passport_issuing_country,
                    'expiration' => $app->passport_expiration_date?->format('m/d/Y'),
                ],
                'entry' => [
                    'date' => $app->entry_date?->format('m/d/Y'), // Note: this might duplicate last_arrival_date, checking if entry_date overlaps
                    'location' => $app->entry_location,
                    'last_arrival_date' => $app->last_arrival_date?->format('m/d/Y'),
                    'last_arrival_city' => $app->last_arrival_city,
                    'last_arrival_state' => $app->last_arrival_state,
                    'entry_type' => $app->immigration_entry_type,
                    'entry_status' => $app->immigration_entry_status,
                ],
            ],
            'sponsor' => [
                'personal_information' => [
