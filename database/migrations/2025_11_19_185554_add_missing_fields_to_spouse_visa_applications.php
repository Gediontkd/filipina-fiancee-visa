...
return new class extends Migration
{
    ...
    public function old_up(): void
    {
        Schema::table('simplified_spouse_visa_applications', function (Blueprint $table) {
            ...
            // Citizenship Details
            $table->text('sponsor_citizenship_method')->nullable()->after('sponsor_citizenship');
            $table->text('sponsor_certificate_number')->nullable()->after('sponsor_citizenship_method');
            ...
            $table->text('sponsor_ethnicity')->nullable()->after('sponsor_citizenship');
            ...
            $table->text('sponsor_eye_color')->nullable()->after('sponsor_weight');
            $table->text('sponsor_hair_color')->nullable()->after('sponsor_eye_color');
            ...
            // Contact Information
            $table->text('beneficiary_daytime_phone')->nullable()->after('beneficiary_phone');
            $table->text('beneficiary_mobile_phone')->nullable()->after('beneficiary_daytime_phone');
            ...
            $table->text('beneficiary_intended_city')->nullable()->after('beneficiary_intended_apt');
            ...
            $table->text('beneficiary_employer_city')->nullable()->after('beneficiary_employer_apt');
            $table->text('beneficiary_employer_province')->nullable()->after('beneficiary_employer_city');
            ...
            $table->text('last_lived_together_city')->nullable()->after('last_lived_together_apt');
            $table->string('last_lived_together_state', 2)->nullable()->after('last_lived_together_city');
            $table->text('last_lived_together_province')->nullable()->after('last_lived_together_state');
