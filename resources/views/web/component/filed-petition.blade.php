<!-- resources\views\web\component\filed-petition.blade.php -->
<div class="row filedPetitionForm">
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <span class="required">*</span>
            {{ Form::text("alien_mname$index", @$step->detail["alien_mname$index"], ['class' => 'form-control', 'placeholder' => 'Enter Name']) }}        
        </div>
    </div>
    <div class="col-md-12">
        <div class="form-group">
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <span class="required">*</span>
            {{ Form::text("alien_reg_no$index", @$step->detail["alien_reg_no$index"], ['class' => 'form-control', 'placeholder' => 'Enter Number']) }}        
        </div>
    </div>
    <div class="col-md-12">
        <div class="form-group">
            ...
            <span class="required">*</span>
            {{ Form::text("alien_city_filing$index", @$step->detail["alien_city_filing$index"], ['class' => 'form-control', 'placeholder' => 'Enter Number']) }}        
        </div>
    </div>
    <div class="col-md-12">
        <div class="form-group">
