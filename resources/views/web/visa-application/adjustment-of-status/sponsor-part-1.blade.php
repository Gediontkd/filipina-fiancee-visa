...
<div class="step-wizard">    
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <span class="required">*</span>
                        {{ Form::number('feet', @$step->detail['feet'], ['class' => 'form-control', 'placeholder' => 'Enter Feet', 'step' => '0.1', 'id' => 'aos_sponsor_height_feet']) }}        
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <span class="required">*</span>
                        {{ Form::number('inches', @$step->detail['inches'], ['class' => 'form-control', 'placeholder' => 'Enter Inches', 'step' => '0.1', 'id' => 'aos_sponsor_height_inches']) }}        
                    </div>
                </div>
                <h5>Weight</h5>
                <div class="col-md-12">
    ...
    <script type="text/javascript">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const feetInput = document.getElementById('aos_sponsor_height_feet');
            const incInput = document.getElementById('aos_sponsor_height_inches');
