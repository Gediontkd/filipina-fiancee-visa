<!-- resources\views\web\visa-application\fiance-visa\alien-children\child-2.blade.php -->
<div class="step-wizard">
    {{ Form::open(['url' => route('fianceAlienChild2'), 'id' => 'fianceAlienChild2']) }}
        <div class="form-card">
            <div class="row">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label>You have entered one child. Do you have a second child to add? </label>
        ...
        {!! Form::hidden('name', 'child-2') !!}
        {!! Form::hidden('next', 'child-3') !!}
    ...
    <script type="text/javascript">
        ...
        $("#fianceAlienChild2").validate({
            ...
            submitHandler: function(form) {
                $('#fianceAlienChild2Btn').html('Processing <i class="fa fa-spinner fa-spin"></i>');
                ...
                $.ajax({
                    ...
                    type: 'post',
                    url: "{{ route('fianceAlienChild2') }}",
                    data: serializedData,
                    dataType: 'json',
                    success: function(data) {               
                        if (data.status == true) {                                           
                            $('.activechild-2').removeClass('active');
                            $('.activechild-3').addClass('active');
