<!-- resources\views\web\visa-application\fiance-visa\alien-children\child-3.blade.php -->
<div class="step-wizard">
    {{ Form::open(['url' => route('fianceAlienChild3'), 'id' => 'fianceAlienChild3']) }}
        <div class="form-card">
            <div class="row">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label>You have entered two child. Do you have a third child to add? </label>
        ...
        {!! Form::hidden('name', 'child-3') !!}
        {!! Form::hidden('next', 'child-4') !!}
    ...
    <script type="text/javascript">
        ...
        $("#fianceAlienChild3").validate({
            ...
            submitHandler: function(form) {
                $('#fianceAlienChild3Btn').html('Processing <i class="fa fa-spinner fa-spin"></i>');
                ...
                $.ajax({
                    ...
                    type: 'post',
                    url: "{{ route('fianceAlienChild3') }}",
                    data: serializedData,
                    dataType: 'json',
                    success: function(data) {               
                        if (data.status == true) {                                           
                            $('.activechild-3').removeClass('active');
                            $('.activechild-4').addClass('active');
