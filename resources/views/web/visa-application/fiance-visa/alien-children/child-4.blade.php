...
<div class="step-wizard">
    {{ Form::open(['url' => route('fianceAlienChild4'), 'id' => 'fianceAlienChild4']) }}
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label>You have entered three child. Do you have a fourth child to add? </label>
        ...
        {!! Form::hidden('name', 'child-4') !!}
        {!! Form::hidden('next', 'child-5') !!}
    ...
    <script type="text/javascript">
        ...
        $("#fianceAlienChild4").validate({
            ...
            submitHandler: function(form) {
                $('#fianceAlienChild4Btn').html('Processing <i class="fa fa-spinner fa-spin"></i>');
                ...
                $.ajax({
                    ...
                    type: 'post',
                    url: "{{ route('fianceAlienChild4') }}",
                    data: serializedData,
                    dataType: 'json',
                    success: function(data) {               
                        if (data.status == true) {                                           
                            $('.activechild-4').removeClass('active');
                            $('.activechild-5').addClass('active');
