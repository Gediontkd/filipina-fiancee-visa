    ...
    <div class="form-card">
        ...
        <div class="row">
            @php
                ...
                // Check if Philippines (ID 232) exists, otherwise try to find it
                $philippinesId = 232;
                if (!isset($countries[$philippinesId])) {
                    // Try to find Philippines by name if ID changed
                    foreach($countries as $id => $name) {
                        if (stripos($name, 'Philippines') !== false) {
                            $philippinesId = $id;
                            break;
                        }
                    }
                ...
                if (isset($countries[$philippinesId])) {
                    $philippines = $countries[$philippinesId];
                    unset($countries[$philippinesId]);
                    $countries = array_reverse($countries, true);
                    $countries[$philippinesId] = $philippines;
                    $countries = array_reverse($countries, true);
                }
            @endphp
            <div class="col-md-4">
