<!-- resources\views\web\visa-application\fiance-visa\alien\name.blade.php -->
<div class="step-wizard">
    {{ Form::open(['url' => route('fianceAlienName'), 'id' => 'fianceAlienName']) }}
        <div class="form-card">
            <div class="heading mb-30">
                <h2>Alien's Name And Gender</h2>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <span class="required">*</span>
    					{{ Form::text('middle_name', @$step->detail['fMLName'] ? 'N/A' : @$step->detail['middle_name'], [
                            'class' => 'form-control fMLName',
                            'placeholder' => 'Enter Middle Name'
                        ]) }}
                        @include('web.component.does-not-apply', ['field' => 'fMLName', 'value' => @$step->detail['fMLName']])
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <span class="required">*</span>
                                {{ Form::text("prior1_mname", @$step->detail['mName1'] ? 'N/A' : @$step->detail['prior1_mname'], [
                                    'class' => 'form-control mName1',
                                    'placeholder' => 'Enter name'
                                ]) }}
                                @include('web.component.does-not-apply', ['field' => 'mName1', 'value' => @$step->detail['mName1']])           
                            </div>                            
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <span class="required">*</span>
                                {{ Form::text("prior2_mname", @$step->detail['mName2'] ? 'N/A' : @$step->detail['prior2_mname'], [
                                    'class' => 'form-control mName2',
                                    'placeholder' => 'Enter name'
                                ]) }}
                                @include('web.component.does-not-apply', ['field' => 'mName2', 'value' => @$step->detail['mName2']])                      
                            </div>                            
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <span class="required">*</span>
                                {{ Form::text("prior3_mname", @$step->detail['mName3'] ? 'N/A' : @$step->detail['prior3_mname'], [
                                    'class' => 'form-control mName3',
                                    'placeholder' => 'Enter name'
                                ]) }}
                                @include('web.component.does-not-apply', ['field' => 'mName3', 'value' => @$step->detail['mName3']])               
                            </div>                            
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        $("#fianceAlienName").validate({
            ...
            submitHandler: function(form) {
                $('#fianceAlienNameBtn').html('Processing <i class="fa fa-spinner fa-spin"></i>');
                ...
                $.ajax({
                    ...
                    type: 'post',
                    url: "{{ route('fianceAlienName') }}",
                    data: serializedData,
                    dataType: 'json',
                    success: function(data) {               
                        if (data.status == true) {                                           
                            $('.activename').removeClass('active');
                            $('.activecitizenship').addClass('active');
