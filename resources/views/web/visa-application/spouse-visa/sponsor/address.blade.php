<!-- resources\views\web\visa-application\spouse-visa\sponsor\address.blade.php -->
<div class="step-wizard">
    ...
    $.ajax({
        ...
        success: function(data) {               
            if (data.status) {                                           
                $('.sponsor-address').removeClass('active');
                $('.sponsor-relationship').addClass('active');
        ...
        complete: function() {
            $('#spouseAddressBtn').html('Save & Continue')
                .prop('disabled', false);
        }
    });
    return false;
